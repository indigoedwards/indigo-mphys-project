...
output_filename = "energylevel-output89.txt"   
...
for excitation in excitationlist:
    ...
    for distance in distancelist:
        ...
        enablePrint()
        idea.state.save_many_body_state(solvedstate,f"./89/e{excitation}d{str(distance).replace('.','-')}.state")
        energylist[excitation-8].append(solvedstate.energy)
    ...
    plt.plot(distancelist,energylist[excitation-8])
