...
output_filename = "energylevel-output01.txt"   
...
for excitation in excitationlist:
    ...
    for distance in distancelist:
        ...
        enablePrint()
        idea.state.save_many_body_state(solvedstate,f"./01/e{excitation}d{str(distance).replace('.','-')}.state")
        energylist[excitation].append(solvedstate.energy)
