...
output_filename = "energylevel-output67.txt"   
...
for excitation in excitationlist:
    ...
    for distance in distancelist:
        ...
        enablePrint()
        idea.state.save_many_body_state(solvedstate,f"./67/e{excitation}d{str(distance).replace('.','-')}.state")
        energylist[excitation-6].append(solvedstate.energy)
    ...
    plt.plot(distancelist,energylist[excitation-6])
